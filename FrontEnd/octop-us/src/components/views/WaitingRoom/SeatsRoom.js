        ...
        <div className="row">
            <div id="leftside" className="offset-2 col-4">
                <div className="container col" style={{opacity: seats[0].opacity}}>
                    <p>{seats[0].nickname}</p><p><FontAwesomeIcon icon="fa-solid fa-crown" style={{ opacity : throne[0].crown}}/></p>
                    {/* 폰트어썸으로 왕관 넣을 예정 */}
            ...
            <a target="_blank" href="https://icons8.com/icon/59DW1U5zYwbI/octopus">Octopus icon by Icons8</a>
            <a target="_blank" href="https://icons8.com/icon/fcj8w2EL5ShF/octopus">Octopus icon by Icons8</a>
        </div>
    )
}