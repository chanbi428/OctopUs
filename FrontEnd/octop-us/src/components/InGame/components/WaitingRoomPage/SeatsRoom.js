  ...
  return (
    <div className="col d-flex flex-column align-items-center">
      ...
      <div className="container col" style={{ opacity: seatInfo[1].opa }}  id="num_one">
          ...
          <img className="octopus" src="images/octopus/yellow.gif" alt="octopus1.gif" id="move_octo"/>
        </div>
        <div className="container col" style={{ opacity: seatInfo[0].opa }} id="num_zero">
          ...
          <img className="octopus" src="images/octopus/red.gif" alt="octopus0.gif" id="move_octo"/>
        </div>
        <div className="container col" style={{ opacity: seatInfo[4].opa }} id="num_four">
          ...
          <img className="octopus" src="images/octopus/purple.gif" alt="octopus4.gif" id="move_octo"/>
        </div>
        <div className="container col" style={{ opacity: seatInfo[5].opa }} id="num_five">
          ...
          <img className="octopus" src="images/octopus/babypink.gif" alt="octopus5.gif" id="move_octo"/>
        </div>
      </div>
      <div className="row">
      <div className="container col" style={{ opacity: seatInfo[2].opa }}  id="num_two">
          ...
          <img className="octopus" src="images/octopus/green.gif" alt="octopus2.gif" id="move_octo"/>
        </div>
        <div className="container col" style={{ opacity: seatInfo[3].opa }} id="num_thr">
          ...
          <img className="octopus" src="images/octopus/mint.gif" alt="octopus3.gif" id="move_octo"/>
        </div>
        <div className="container col" style={{ opacity: seatInfo[7].opa }} id="num_svn">
          ...
          <img className="octopus" src="images/octopus/blue.gif" alt="octopus6.gif" id="move_octo"/>
        </div>
        <div className="container col" style={{ opacity: seatInfo[6].opa }} id="num_six"> 
          ...
          <img className="octopus" src="images/octopus/violet.gif" alt="octopus7.gif" id="move_octo"/>
        </div>
      </div>
    </div>
  );
